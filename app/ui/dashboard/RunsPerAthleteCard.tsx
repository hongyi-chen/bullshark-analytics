  ...
  return (
    ...
    >
      <div
        className={css.chart}
        role="img"
        aria-label={`Horizontal bar chart showing top 10 athletes by run count for this ${timeFilter}. ${runsBarData.length > 0 ? `Leading athlete: ${runsBarData[0]?.athlete} with ${runsBarData[0]?.runs} runs.` : 'No data available.'}`}
      >
        <ResponsiveContainer>
          <BarChart
            data={runsBarData}
