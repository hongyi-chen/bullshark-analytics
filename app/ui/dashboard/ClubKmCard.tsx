...
export default function ClubKmCard({
  ...
  return (
    ...
    >
      <div className="flexFill" role="img" aria-label={`Line chart showing club kilometers ${aggregation === "daily" ? "per day" : "per week"} for this ${timeFilter}. Total: ${fmtKm(totalKm)} km`}>
