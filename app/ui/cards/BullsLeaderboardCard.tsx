...
import css from "./BullsLeaderboardCard.module.scss";
...
interface BullsLeaderboardCardProps {
  athletes: Athlete[];
  totalKm: number;
}

export default function BullsLeaderboardCard({
  athletes,
  totalKm,
}: BullsLeaderboardCardProps) {
  return (
    <Card
      header={
        <>
