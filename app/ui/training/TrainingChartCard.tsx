  ...
  return (
    <Card fixedTall style={{ height: '600px' }}>
      ...
      <div
        ...
        role="img"
        aria-label={`Line chart showing weekly training kilometers for ${athletes.length} athlete${athletes.length !== 1 ? 's' : ''}.${focusedAthleteName ? ` Currently focused on ${focusedAthleteName}.` : ''}`}
      >
