  ...
  return (
    <Card>
      <div className={css.container}>
        ...
        {hasWarnings ? (
          <div className={css.warningsList} role="list" aria-label="Training warnings">
            {riskyWeeksArray.map(({ week, riskCount, risks }) => (
              <div key={week} className={`${css.warningItem} ${getRiskSeverityClass(riskCount)}`} role="listitem">
